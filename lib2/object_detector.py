...
class detector(nn.Module):
    ...
    def __init__(self, checkpoint,train, object_classes, use_SUPPLY, mode='predcls'):
        ...
        #checkpoint = torch.load('fasterRCNN/models/faster_rcnn_ag.pth') #to be changed into faster_rcnn_coco.pth
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes, gt_annotation, im_all=None):
